...
- (void)userMessageReceived:(EduTextMessage*)textMessage {
    ...
    switch (dataModel.type) {
        case SignalLinkStateTeaReject:
            [BaseViewController showToast:NSLocalizedString(@"RejectRequestText", nil)];
            break;
        case SignalLinkStateTeaAccept:
            [BaseViewController showToast:NSLocalizedString(@"AcceptRequestText", nil)];
            break;
        case SignalLinkStateTeaClose:
            [BaseViewController showToast:NSLocalizedString(@"TeaCloseCoVideoText", nil)];
            break;
        default:
            break;
    }
