...
- (void)awakeFromNib {
    ...
    self.roomNameArray = [NSMutableArray arrayWithObjects:NSLocalizedString(@"OneToOneText", nil),
                          ...
                          NSLocalizedString(@"BigClassText", nil),
                          NSLocalizedString(@"BreakOutClassText", nil),
                          NSLocalizedString(@"MediumClassText", nil),
                          nil];
...
- (UITableView *)typeTableView {
    if (!_typeTableView) {
        ...
        _typeTableView.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 0.f)];
        _typeTableView.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 0.f)];
